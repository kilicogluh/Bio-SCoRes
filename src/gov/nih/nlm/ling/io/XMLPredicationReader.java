 ...
 *
 */
public class XMLPredicationReader implements XMLRelationReader {
	private static final Logger log = Logger.getLogger(XMLPredicationReader.class.getName());

	public XMLPredicationReader() {}
